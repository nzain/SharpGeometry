...
{
    /// <summary>Tolerant equality comparer based on a tolerance. Not useful for hashing. Tolerant equality is implemented for
    ...
    {
        /// <summary>Creates a new <see cref="Vector3D" /> equality comparer.</summary>
        ...
        /// <summary>Gets the tolerance (per dimension).</summary>
